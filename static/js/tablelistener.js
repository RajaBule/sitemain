document.addEventListener('DOMContentLoaded', function() {
    ...
    searchInput.addEventListener('input', function() {
        ...
        $.ajax({
            url: `/search/?q=${searchQuery}&selected=${selectedValue}`, // Modify the URL as needed
            dataType: 'json',
    ...
    $(document).ready(function () {
        ...
        tableBody.on('click', 'tr', function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.success) {
                        alert("Samples shared successfully!");
                    } else {
                        if (data.error) {
                            alert("There was a problem sharing samples! ERROR: " + data.error);
